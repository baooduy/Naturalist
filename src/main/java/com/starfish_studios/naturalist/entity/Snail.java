...
public class Snail extends AnimalEntity implements IAnimatable, Bucketable {
    ...
    public ItemStack getBucketItem() {
        return new ItemStack(NaturalistItems.SNAIL_BUCKET);
    }
    ...
    protected SoundEvent getDeathSound() {
        return NaturalistSoundEvents.SNAIL_CRUSH;
    }
    ...
    private void soundListener(SoundKeyframeEvent<Snail> event) {
        ...
        if (snail.world.isClient) {
            if (event.sound.equals("forward")) {
                snail.world.playSound(snail.getX(), snail.getY(), snail.getZ(), NaturalistSoundEvents.SNAIL_FORWARD, snail.getSoundCategory(), 0.5F, 1.0F, false);
            }
            if (event.sound.equals("back")) {
                snail.world.playSound(snail.getX(), snail.getY(), snail.getZ(), NaturalistSoundEvents.SNAIL_BACK, snail.getSoundCategory(), 0.5F, 1.0F, false);
            }
        }
    }
